...
//                    reunion.getDetalle());
//
//            redirectAttributes.addFlashAttribute("exito", "Reuni√≥n creada con √©xito");
//            return "redirect:/reunion/calendario_reuniones";
//        } catch (Exception e) {
//            redirectAttributes.addFlashAttribute("error", "Error al crear la reuni√≥n: " + e.getMessage());
        ...
        try {
            ...
            Reunion reunionGuardada = reunionServicio.crear(
             ...
             if (reunionGuardada != null && reunionGuardada.getId() != null) {
                redirectAttrs.addFlashAttribute("exito", "La reuniÛn fue creada con Èxito");
